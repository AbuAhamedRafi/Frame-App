...
var canvas = new fabric.Canvas('preview_panel', {width: cw, height:cw / 350 * 350});
...
window.updatePreview = function(url) {
  ...
  fabric.Image.fromURL(url, function(img) {
    ...
    var oImg = img.set({ left: 0, top: 0, cornerColor: 'red', cornerSize: 20, transparentCorners: false, borderColor: 'red'}).scale(resizeRatio / 1);
    canvas.add(oImg);
